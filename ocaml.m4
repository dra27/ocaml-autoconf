...
[dnl
  ...
  if test "$OCAMLC" != "no"; then
     OCAMLVERSION=`$OCAMLC -v | tr -d '\015' | sed -n -e 's|.*version ||p'`
     ...
     if test "$OCAMLOPT" = "no"; then
        ...
        TMPVERSION=`$OCAMLOPT -v | tr -d '\015' | sed -n -e 's|.*version ||p' `
     ...
     if test "$OCAMLCDOTOPT" != "no"; then
        TMPVERSION=`$OCAMLCDOTOPT -v | tr -d '\015' | sed -n -e 's|.*version ||p' `
        if test "$TMPVERSION" != "$OCAMLVERSION" ; then
     ...
     if test "$OCAMLOPT" != "no" ; then
        ...
        if test "$OCAMLOPTDOTOPT" != "no"; then
           TMPVERSION=`$OCAMLOPTDOTOPT -v | tr -d '\015' | sed -n -e 's|.*version ||p' `
           if test "$TMPVERSION" != "$OCAMLVERSION" ; then
  ...
  if test "$OCAMLDEP" != "no" ; then
    ...
    if test "$OCAMLDEPDOTOPT" != "no"; then
      TMPVERSION=`$OCAMLDEPDOTOPT -version 2>/dev/null | tr -d '\015' | sed -n -e 's|.*version ||p' `
      if test "$TMPVERSION" != "$OCAMLVERSION" ; then
...
[dnl
  ...
  if test "$CAMLP4" != "no"; then
     TMPVERSION=`$CAMLP4 -v 2>&1| tr -d '\015' | sed -n -e 's|.*version ||p'`
     if test "$TMPVERSION" != "$OCAMLVERSION" ; then
