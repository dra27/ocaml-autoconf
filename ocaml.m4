...
[dnl
  ...
  if test "$OCAMLC" != "no"; then
     OCAMLVERSION=`$OCAMLC -v | sed -n -e 's|.*version ||p'`
     ...
     if test "$OCAMLOPT" = "no"; then
        ...
        TMPVERSION=`$OCAMLOPT -v | sed -n -e 's|.*version ||p' `
     ...
     if test "$OCAMLCDOTOPT" != "no"; then
        TMPVERSION=`$OCAMLCDOTOPT -v | sed -n -e 's|.*version ||p' `
        if test "$TMPVERSION" != "$OCAMLVERSION" ; then
     ...
     if test "$OCAMLOPT" != "no" ; then
        ...
        if test "$OCAMLOPTDOTOPT" != "no"; then
           TMPVERSION=`$OCAMLOPTDOTOPT -v | sed -n -e 's|.*version ||p' `
           if test "$TMPVERSION" != "$OCAMLVERSION" ; then
...
[dnl
  ...
  if test "$CAMLP4" != "no"; then
     TMPVERSION=`$CAMLP4 -v 2>&1| sed -n -e 's|.*version ||p'`
     if test "$TMPVERSION" != "$OCAMLVERSION" ; then
